...
{
    public class SchoolNewsRepository : GenericRepositoryAsync<SchoolNews>, ISchoolNewsRepository
    {
   
        private readonly YemenShoolsDbContext dbContext;

        public SchoolNewsRepository(YemenShoolsDbContext dbContext) : base(dbContext)
        {
