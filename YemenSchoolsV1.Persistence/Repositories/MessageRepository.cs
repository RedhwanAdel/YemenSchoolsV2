...
namespace YemenSchoolsV1.Persistence.Repositories
{
    public class MessageRepository : GenericRepositoryAsync<Message>, IMessageRepository
    {
        ...
        public async Task<PaginatedResponse<MessageDto>> GetMessagesForMember(MessageParams
            messageParams)
        {
            ...
            return await messageQuery.ToPaginatedListAsync(messageParams.PageNumber,
