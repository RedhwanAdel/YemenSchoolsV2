...
namespace YemenSchoolsV1.Persistence.Repositories
{
	public class GenericRepositoryAsync<T> : IGenericRepositoryAsync<T> where T : class
	{
        ...
        public void Commit()
        {
            // Note: This relies on an external transaction being started. 
            // Better to use BeginTransaction if explicit commit is needed.
                    ...
                    List<Expression<Func<T, object>>>? includes = null)
        {
            ...
            return PaginatedResult<T>.Success(data, totalRecords, paginationQuery.PageNumber, paginationQuery.PageSize);
        }
