        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SchoolNews_Schools_SchoolId",
                        column: x => x.SchoolId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_schoolPhones", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolNewsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsPhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NewsPhotos_SchoolNews_SchoolNewsId",
                        column: x => x.SchoolNewsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsPhotos_SchoolNewsId",
                table: "NewsPhotos",
                column: "SchoolNewsId");
